...
public record PhotoListResDto(
    @Schema(description = "1. 자신의 청춘을 가장 잘 담은 사진 목록 (6개)") List<PhotoSummaryDto> youthPhotos,
    @Schema(description = "2. 축제 현장을 가장 잘 담은 사진 목록 (6개)") List<PhotoSummaryDto> festivalPhotos,
